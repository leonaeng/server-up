...
define('CAMPAIGN_ID', "b362e621d1076dc9307ee0da9301b940");
define('REQUEST_LIVE_TIME', 3600);
define('ENC_KEY', '397c95d323f4358b44a921b96d4a7558');
define('MP_PARAM_NAME', '__olid');
define('NOT_FOUND_TEXT', '<h1>Page not found</h1>');
define('CHECK_MCPROXY', 0);
define('CHECK_MCPROXY_PARAM', '522f51eca2d7de52fd86bcddb9741c3b');
define('CHECK_MCPROXY_VALUE', '173f8a3c4578a1fd5e72c74d188f7c1a8c3d8a87b048a5d09e7af5c340c6a07b');
...
function sendRequest($data, $path = 'index') {
    ...
    $data_to_post = array("cmp"=> CAMPAIGN_ID,"headers" => $data,"adapi" => '2.2', "sv" => '17628.3');
