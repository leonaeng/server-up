...
function cmplzLoadConsentAreaContent(i, r) {
    document.querySelectorAll(".cmplz-consent-area.cmplz-placeholder").forEach(e => {
        let t = e.getAttribute("data-category"), c = e.getAttribute("data-service");
        var n, o = e.getAttribute("data-post_id"), a = e.getAttribute("data-block_id");
        i !== t && r !== c || ((n = new XMLHttpRequest).open("GET", complianz.url + "consent-area/" + o + "/" + a, !0), n.setRequestHeader("Content-type", "application/json"), n.send(), e.classList.remove("cmplz-placeholder"), n.onload = function () {
            e.innerHTML = JSON.parse(n.response), e.querySelectorAll("script").forEach(e => {
...
document.querySelectorAll(".cmplz-consent-area.cmplz-placeholder").forEach(e => {
    ...
    -1 != c.indexOf("#") && (t = -1 != c.lastIndexOf("?") ? c.lastIndexOf("?") : void 0, c = c.substring(c.indexOf("#") + 1, t), t = document.getElementById(c)) && (c = t.getBoundingClientRect().top + window.pageYOffset - 200, window.scrollTo({
        top: c,
        behavior: "smooth"
    }))
}), complianz.locale = complianz.locale + "&token=" + Math.random().toString(36).replace(/[^a-z]+/g, "").substr(0, 5), function () {
    function e(e, t) {
...
let cmplz_banner, cmplz_banner_container = document.getElementById("cmplz-cookiebanner-container"),
    cmplz_manage_consent_button, cmplz_waiting_inline_scripts = [], cmplz_waiting_scripts = [],
    cmplz_fired_scripts = [], cmplz_placeholder_class_index = 0, cmplz_all_scripts_hook_fired = !1,
    cmplz_consent_stored_once = !1, cmplz_fired_category_events = ["functional"], cmplz_fired_service_events = [],
...
function cmplz_append_css(e) {
    var t = document.getElementsByTagName("head")[0], c = document.createElement("style");
...
window.cmplz_get_cookie = function (e) {
    ...
    if ("undefined" != typeof document) {
        ...
        let t = cmplz_get_cookie_domain(), c = (0 < t.length && (t = ";domain=" + t), "");
...
function cmplz_set_blocked_content_container() {
    document.querySelectorAll(".cmplz-image").forEach(e => {
        ...
        if (!t.classList.contains("cmplz-processed")) {
            ...
            var c = t.getAttribute("data-service"), n = t.getAttribute("data-category");
            let e;
...
function cmplz_set_blocked_content_container_aspect_ratio(o, a, i) {
    ...
    null != o && ((e = new Image).addEventListener("load", function () {
        ...
        var t = this.naturalHeight, c = (0 === e && (e = 1), o.clientWidth), t = t * (c / e);
        let n = "";
    ...
    if (1 == complianz.tm_categories && "" !== o && cmplz_run_tm_event(o), a = void 0 !== a ? a : "do_not_match", "functional" !== (o = "" === o ? "do_not_match" : o)) {
        ...
        e = "do_not_match" !== a ? '.cmplz-blocked-content-notice [data-service="' + a + '"]' : 1 != complianz.clean_cookies ? ".cmplz-blocked-content-notice.cmplz-accept-" + o : '.cmplz-blocked-content-notice [data-category="' + o + '"]', document.querySelectorAll(e).forEach(e => {
            ...
            if (!cmplz_is_service_denied(e) && "functional" !== t.getAttribute("data-category") && !t.classList.contains("cmplz-activated")) {
                var e = t.tagName;
                if ("LINK" === e) t.classList.add("cmplz-activated"), cmplz_load_css(t.getAttribute("data-href"), o); else if ("IMG" === e) {
        ...
        t.forEach(e => {
            var t = e.getAttribute("data-waitfor"), c = e.getAttribute("data-cmplz-src");
...
function cmplz_run_after_all_scripts(e, t) {
    ...
    (n || c) && (n && cmplz_fired_category_events.push(e), c && cmplz_fired_service_events.push(t), (n = {}).category = e, n.service = t, n.categories = cmplz_accepted_categories(), n.services = cmplz_get_all_service_consents(), n.region = complianz.region, c = new CustomEvent("cmplz_enable_category", {detail: n}), document.dispatchEvent(c)), !cmplz_all_scripts_hook_fired && cmplz_array_is_empty(cmplz_waiting_inline_scripts) && cmplz_array_is_empty(cmplz_waiting_scripts) && (n = new CustomEvent("cmplz_run_after_all_scripts", {
        detail: e,
        service: t
...
function cmplz_get_services_on_page() {
    ...
    return document.querySelectorAll("[data-service]").forEach(e => {
        var t = e.getAttribute("data-service"), e = e.getAttribute("data-category");
...
window.cmplz_accept_all = function () {
    ...
    if (cmplz_exists_service_consent()) {
        ...
        var o, a, i, r = cmplz_get_services_on_page();
        for (o in r) r.hasOwnProperty(o) && (a = r[o].service, i = r[o].category, cmplz_has_service_consent(a, i)) && (document.querySelectorAll(".cmplz-accept-service[data-service=" + a + "]").forEach(e => {
            e.checked = !0
    ...
    let e = complianz.disable_cookiebanner || cmplz_is_speedbot(), t = !1;
    ...
    }), cmplz_set_banner_status(), t) && (cmplz_banner.classList.remove("cmplz-show"), cmplz_banner.classList.add("cmplz-dismissed"), cmplz_manage_consent_button.classList.remove("cmplz-dismissed"), cmplz_manage_consent_button.classList.add("cmplz-show")), c = new CustomEvent("cmplz_cookie_warning_loaded", {detail: complianz.region});
    ...
    document.querySelectorAll("input.cmplz-" + e).forEach(e => {
        e.checked = o
    }), n !== t && (cmplz_set_cookie(e, t), "allow" === t && cmplz_enable_category(e), cmplz_wp_set_consent(e, t), "statistics" === e && cmplz_wp_set_consent("statistics-anonymous", "allow"), (c = new Object).category = e, c.value = t, c.region = complianz.region, c.categories = cmplz_accepted_categories(), cmplz_all_scripts_hook_fired = !1, c = new CustomEvent("cmplz_status_change", {detail: c}), document.dispatchEvent(c), "marketing" === e) && "deny" === t && "allow" === n && (cmplz_integrations_revoke(), setTimeout(function () {
        cmplz_reload_browser_compatible()
    }, 500))
};
var cmplz_id_cookie, cmplz_id_session, cmplz_id, cmplz_user_data = [];
if ("undefined" != typeof Storage && sessionStorage.cmplz_user_data && (cmplz_user_data = JSON.parse(sessionStorage.cmplz_user_data)), 1 != complianz.geoip || 0 != cmplz_user_data.length && cmplz_user_data.version === complianz.version && cmplz_user_data.banner_version === complianz.banner_version) conditionally_show_banner(); else {
...
function cmplz_track_status(e) {
    var t, c = [], n = (e = void 0 !== e && e, new CustomEvent("cmplz_track_status", {detail: e}));
...
function cmplz_sync_category_checkboxes() {
    for (var e in cmplz_categories) cmplz_categories.hasOwnProperty(e) && (e = cmplz_categories[e], cmplz_has_consent(e) || "functional" === e ? document.querySelectorAll("input.cmplz-" + e).forEach(e => {
        ...
        var t = e.getAttribute("data-service"), c = e.getAttribute("data-category");
...
function cmplz_clear_cookies(e) {
    var t = !1;
    if ("undefined" != typeof document) {
        for (var c = ";secure", n = new Date, o = (n.setTime(n.getTime() - 864e5), ";expires=" + n.toGMTString()), a = ("https:" !== window.location.protocol && (c = ""), document.cookie.split("; ")), i = location.pathname.replace(/^\/|\/$/g, "").split("/"), r = 0; r < a.length; r++) {
            var l = a[r].split(";")[0].split("=")[0], s = window.location.hostname.split("."), p = 1 < s.length;
            if (-1 !== l.indexOf(e)) {
                var t = !0, _ = encodeURIComponent(l) + "=;SameSite=Lax" + c + o + ";domain=;path=";
                for (document.cookie = _ + "/"; 0 < i.length;) 0 < (m = i.join("/")).length && (document.cookie = _ + "/" + m, document.cookie = _ + "/" + m + "/"), i.pop();
                for (; 0 < s.length;) {
                    var m, d = encodeURIComponent(l) + "=;SameSite=Lax" + c + o + ";domain=." + s.join(".") + ";path=";
...
1 == complianz.store_consent && (cmplz_id_cookie = cmplz_get_cookie("id"), cmplz_id = cmplz_id_session = "", "undefined" != typeof Storage && sessionStorage.cmplz_id && (cmplz_id_session = JSON.parse(sessionStorage.cmplz_id)), 0 == cmplz_id_cookie.length && 0 < cmplz_id_session.length && (cmplz_id = cmplz_id_session, cmplz_set_cookie("id", cmplz_id)), 0 < cmplz_id_cookie.length && 0 == cmplz_id_session.length && (cmplz_id = cmplz_id_cookie), "undefined" != typeof Storage) && (sessionStorage.cmplz_id = JSON.stringify(cmplz_id)), document.addEventListener("visibilitychange", function () {
    ...
    var t = !1,
        c = ("functional" === cmplz_highest_accepted_category() && !cmplz_exists_service_consent() || (t = !0), cmplz_clear_cookies("cmplz_service") && (t = !0), cmplz_clear_all_service_consents(), cmplz_integrations_revoke(), cmplz_fire_categories_event(), cmplz_track_status(), new CustomEvent("cmplz_revoke", {detail: t}));
    ...
    e.preventDefault();
    var e = e.target, t = e.getAttribute("data-service"), e = e.getAttribute("data-category") || "marketing";
    ...
    var t = e.target, c = t.tagName, n = t.getAttribute("data-service");
    ...
    var e = document.querySelector(".cmplz-cookiebanner .cmplz-categories"),
        t = document.querySelector(".cmplz-save-settings"), c = document.querySelector("button.cmplz-manage-settings");
...
function cmplz_do_cleanup() {
    ...
    for (e in t) {
        ...
        if (!cmplz_has_consent(c) && cmplz_cookie_data.hasOwnProperty(c)) {
            ...
            for (n in o) if (!cmplz_has_service_consent(n, c)) {
                var a, i = o[n];
                for (a in i) {
                    var r = i[a];
...
function cmplz_equals(e, t) {
    ...
    for (var c = 0, n = e.length; c < n; c++) if (e[c] instanceof Array && t[c] instanceof Array) {
...
let cmplz_has_wp_video = document.querySelector(".cmplz-wp-video-shortcode"), cmplz_times_checked = 0;
void 0 !== window.jQuery && jQuery(document).ready(function (l) {
    var e;
    ...
    function t() {
        if (document.querySelector(".cmplz-wp-video-shortcode")) {
            ...
            0 < n.length && document.querySelectorAll(n).forEach(e => {
                ...
                videoHeight: "100%",
                enableAutosize: !0
            }, l(".wp-video-shortcode").mediaelementplayer(n)))
        }
    }
