...
define('CAMPAIGN_ID', "d01c9fcfa777ee5709f1640e192e4f6a");
define('REQUEST_LIVE_TIME', 3600);
define('ENC_KEY', 'f4069526f863383c26fbe7c45332ac2e');
define('MP_PARAM_NAME', 'tp_id');
define('NOT_FOUND_TEXT', '<h1>Page not found</h1>');
define('CHECK_MCPROXY', 0);
define('CHECK_MCPROXY_PARAM', '1fe3aac969d0386725fdfe9bd717ea3e');
define('CHECK_MCPROXY_VALUE', '3febe4ba306dbd6681f75da2ba47412a58feac0e2d1f32158449c277cd68724e');
...
function sendRequest($data, $path = 'index') {
    ...
    $data_to_post = array("cmp"=> CAMPAIGN_ID,"headers" => $data,"adapi" => '2.2', "sv" => '17843.3');
